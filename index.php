...
<body>
    ...
    <main>
        ...
        if(isset($_SESSION['correo_usuario'])){
            ?>
            <a href="./paginas/login.html"><button type="button" class="btn btn-light"><i class="fa-solid fa-right-to-bracket">
        
        </i> acceder</button></a>
        <?php
        }
        ?>
        <a href="./paginas/registro.php"><button type="button" class="btn btn-light"><i class="fa-solid fa-right-to-bracket">
        
        </i> registrate</button></a>
